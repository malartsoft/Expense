...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
      120, 50, 1150, 600, nullptr, nullptr, hInstance, nullptr);
    ...
    case WM_COMMAND:
        {
			...
			case IDI_ADDBUTTON:
			{
				int sure = MessageBox(hWnd, L"Do you want to add a expense?", L"Confirm ", 1);
				if (sure==1)
					expense.ProcessAdd();
				break;
			}
